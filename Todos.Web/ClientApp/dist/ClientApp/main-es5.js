...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAddEditAddEditComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppITaskServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ServiceMap", function () {
      return ServiceMap;
    });
    /* harmony import */
    ...
    var _task_service_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./task-service.service */
    "./src/app/task-service.service.ts");
    /* harmony import */


    var _urgent_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./urgent.service */
    "./src/app/urgent.service.ts");
    /* harmony import */


    var _last_month_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./last-month.service */
    "./src/app/last-month.service.ts");

    var ServiceMap = new Map().set('MonthTasks', _last_month_service__WEBPACK_IMPORTED_MODULE_3__["LastMonthService"]).set('UrgentTasks', _urgent_service__WEBPACK_IMPORTED_MODULE_2__["UrgentService"]).set('AllTasks', _task_service_service__WEBPACK_IMPORTED_MODULE_1__["TaskServiceService"]);
    /***/
  },
  ...
  /***/
  function srcAppLoggerInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); // fancy pipe-able operators
    ...
    var LoggingInterceptor = /*#__PURE__*/function () {
      ...
      _createClass(LoggingInterceptor, [{
        ...
        value: function intercept(request, next) {
          console.log(request);
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (response) {
            return console.log("Oh boy we got an answer");
          }, function (error) {
            return console.log("Something might be burning back there");
          }));
        }
      }]);
    ...
    LoggingInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], LoggingInterceptor);
    /***/
  },
  ...
  /***/
  function srcAppModelTodoTaskTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TaskGroupType", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "TodoTask", function () {
      return TodoTask;
    });
    /* harmony import */
    ...
    var TodoTask = function TodoTask() {
  ...
  /***/
  function srcAppAddEditAddEditComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAddEditAddEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Model_TodoTask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../Model/TodoTask */
    "./src/app/Model/TodoTask.ts");
    /* harmony import */
    ...
    var AddEditComponent = /*#__PURE__*/function () {
      function AddEditComponent(formBuilder, taskService, router, route) {
      ...
      _createClass(AddEditComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.id != null) {
            this.taskService.GetTaskById(this.id).subscribe(function (res) {
              _this.todoTask = res;

              _this.registerForm.patchValue({
                Name: _this.todoTask.taskName,
                TaskGroup: _this.todoTask.taskGroup,
                TaskStatus: _this.todoTask.taskStatus,
                DueDate: _this.todoTask.dueDate
              });
            });
          }
        }
        ...
        value: function Submit() {
          ...
          this.todoTask.taskGroup = this.registerForm.value.TaskGroup;
          this.todoTask.taskStatus = this.registerForm.value.TaskStatus;
          this.todoTask.dueDate = this.registerForm.value.DueDate; //going to call Service

          if (this.todoTask.taskId > 0) {
            this.taskService.EditTask(this.todoTask).subscribe(function (data) {
              console.log(data);

              _this2.router.navigate(['/Tasks']);
            });
          } else {
            this.taskService.AddTask(this.todoTask).subscribe(function (data) {
              console.log(data);
        ...
        key: "TaskGroup",
        get: function get() {
          return this.registerForm.get('TaskGroup');
        }
      }, {
        key: "TaskStatus",
        get: function get() {
          return this.registerForm.get('TaskStatus');
        }
      }]);
    ...
    AddEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/add-edit/add-edit.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-edit.component.css */
      "./src/app/add-edit/add-edit.component.css"))["default"]]
    })], AddEditComponent);
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./add-edit/add-edit.component */
    "./src/app/add-edit/add-edit.component.ts");
    /* harmony import */


    var _tasklist_tasklist_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./tasklist/tasklist.component */
    "./src/app/tasklist/tasklist.component.ts");

    var routes = [{
      path: '',
      component: _tasklist_tasklist_component__WEBPACK_IMPORTED_MODULE_4__["TasklistComponent"]
    }, {
      path: 'MonthTasks',
      component: _tasklist_tasklist_component__WEBPACK_IMPORTED_MODULE_4__["TasklistComponent"]
    }, {
      ...
      path: 'AddEdit',
      component: _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_3__["AddEditComponent"]
    }, {
      path: 'AddEdit/:id',
      component: _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_3__["AddEditComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./add-edit/add-edit.component */
    "./src/app/add-edit/add-edit.component.ts");
    /* harmony import */
    ...
    var src_app_LoggerInterceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/LoggerInterceptor */
    "./src/app/LoggerInterceptor.ts");
    /* harmony import */


    var _tasklist_tasklist_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./tasklist/tasklist.component */
    "./src/app/tasklist/tasklist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_5__["AddEditComponent"], _nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_6__["NavBarComponent"], _tasklist_tasklist_component__WEBPACK_IMPORTED_MODULE_10__["TasklistComponent"]],
  ...
  /***/
  function srcAppLastMonthServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LastMonthService", function () {
      return LastMonthService;
    });
    /* harmony import */
    ...
    var LastMonthService = /*#__PURE__*/function () {
      function LastMonthService(httpClient) {
        _classCallCheck(this, LastMonthService);

        this.httpClient = httpClient;
      }

      _createClass(LastMonthService, [{
        key: "getTasks",
        ...
        value: function ErrorHandler(error) {
          ...
          if (error.error instanceof ErrorEvent) {
            ...
            errorMessage = "Error Code : ".concat(error.status, " , Error Message : ").concat(error.message);
          }
    ...
    LastMonthService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    LastMonthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], LastMonthService);
    /***/
  },
  ...
  function srcAppTaskServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TaskServiceService = /*#__PURE__*/function () {
      ...
      _createClass(TaskServiceService, [{
        ...
        value: function AddTask(task) {
          ...
          return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBase + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, JSON.stringify(task), this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.ErrorHandler));
        }
      }, {
        key: "EditTask",
        value: function EditTask(task) {
          console.log("Before Calling POST");
          return this.httpClient.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBase + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, JSON.stringify(task), this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.ErrorHandler));
        }
      }, {
        key: "getTasks",
        value: function getTasks() {
    ...
    TaskServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], TaskServiceService);
    /***/
  },
  ...
  /***/
  function srcAppTasklistTasklistComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppTasklistTasklistComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Model_TodoTask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../Model/TodoTask */
    "./src/app/Model/TodoTask.ts");
    /* harmony import */
    ...
    var _ITaskService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../ITaskService */
    "./src/app/ITaskService.ts");

    var TasklistComponent = /*#__PURE__*/function () {
      function TasklistComponent(injector, route) {
      ...
      _createClass(TasklistComponent, [{
        ...
        key: "loadTasks",
        value: function loadTasks(param) {
          var _this4 = this;

          var injectable = _ITaskService__WEBPACK_IMPORTED_MODULE_5__["ServiceMap"].get(param);

          this.service = this.injector.get(injectable);
          this.service.getTasks().subscribe(function (res) {
            _this4.todoTasks = res;
          });
        }
      }, {
        key: "OnBtnDelete",
        value: function OnBtnDelete(taskId) {
          var _this5 = this;

          console.log("Going to Delete task with Id" + taskId);
          var service = this.injector.get(_task_service_service__WEBPACK_IMPORTED_MODULE_2__["TaskServiceService"]);
          service.DeleteTask(taskId).subscribe(function (res) {
            _this5.loadTasks(_this5.param);
          });
        }
      }]);
    ...
    TasklistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/tasklist/tasklist.component.css"))["default"]]
    })], TasklistComponent);
    /***/
  },
  ...
  /***/
  function srcAppUrgentServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UrgentService", function () {
    ...
    var UrgentService = /*#__PURE__*/function () {
      function UrgentService(httpClient) {
        _classCallCheck(this, UrgentService);

        this.httpClient = httpClient;
      }

      _createClass(UrgentService, [{
        key: "getTasks",
        value: function getTasks() {
    ...
    UrgentService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]
      }];
    };

    UrgentService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], UrgentService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Workspace\Git\Todos\Todos.Web\ClientApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
